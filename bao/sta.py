...
import sta_simple_fsk_packet_source as simple_fsk_packet_source  # embedded python block
import threading



class sta(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "sta")
...
def main(top_block_cls=sta, options=None):
