...
# Author: OpenAI Codex
# Copyright: 2026
# Description: 反复发送 el psy kongroo；无外部 Python 文件依赖
...
class simple_fsk_tx_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.center_frequency_hz = center_frequency_hz = 2432500000
        ...
        self.simple_fsk_packet_receiver = simple_fsk_packet_receiver.blk(sample_rate=samp_rate, samples_per_symbol=samples_per_symbol, deviation_hz=deviation_hz, output_text_path='E:/gnu_tset/bao/rv.txt', output_status_path='E:/gnu_tset/bao/rv.json')
