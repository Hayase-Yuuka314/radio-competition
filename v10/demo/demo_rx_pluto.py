...
# Copyright: 2026
# Description: PlutoSDR -> 突发同步/CFO -> DSSS 解扩 -> 去交�?维特�?-> 解扰/CRC
...
class demo_rx_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.demo_rx_sink = demo_rx_sink.blk(shared_key=shared_key, sample_rate=samp_rate, samples_per_chip=samples_per_chip, code_length=code_length, team_id=team_id, expected_sequence=expected_sequence, output_text_path=r'C:/Users/86186/Desktop/rxoutput.txt', output_json_path=r'C:/Users/86186/Desktop/rx_status.json')
