...
```text
E:\radioconda\python.exe
GNU Radio 3.10.12.0
E:\radioconda\Library\bin\grcc.exe
```
...
```powershell
cd "C:\Users\16839\Desktop\无线电gpt\simple_demo"
& "E:\radioconda\Library\bin\gnuradio-companion.exe" simple_fsk_rx_pluto.grc
```
...
```powershell
cd "C:\Users\16839\Desktop\无线电gpt\simple_demo"
& "E:\radioconda\Library\bin\gnuradio-companion.exe" simple_fsk_tx_pluto.grc
```
...
```powershell
cd "C:\Users\16839\Desktop\无线电gpt\simple_demo"
& "E:\radioconda\Library\bin\grcc.exe" simple_fsk_tx_pluto.grc
& "E:\radioconda\Library\bin\grcc.exe" simple_fsk_rx_pluto.grc
```
