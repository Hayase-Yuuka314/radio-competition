...
class simple_fsk_tx_pluto(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.simple_fsk_packet_receiver = simple_fsk_packet_receiver.blk(sample_rate=samp_rate, samples_per_symbol=samples_per_symbol, deviation_hz=deviation_hz, output_text_path='C:/Users/16839/Desktop/RXTEXT.txt', output_status_path='C:/Users/16839/Desktop/RXSTATUS.json')
