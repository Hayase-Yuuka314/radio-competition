...
class demo_tx_pluto(gr.top_block):
    ...
    def __init__(self):
        ...
        self.manifest_path = manifest_path = r'C:\Users\HP\Desktop\demo\demo\tx_manifest.json'
        self.gap_samples = gap_samples = 25000
        self.device_uri = device_uri = 'usb:1.10.5'
